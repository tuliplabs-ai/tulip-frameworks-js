...
reported to the maintainers privately through GitHub
([@tuliplabs-ai](https://github.com/tuliplabs-ai)). All complaints will be
...
2. **Warning** — a warning with consequences for continued behavior, including
   restricted interaction with the people involved for a specified period.
